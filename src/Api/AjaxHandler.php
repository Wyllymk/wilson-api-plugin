...
class AjaxHandler {
    ...
    public function init() {
        ...
        add_action('wp_ajax_' . self::ACTION, [$this, 'handle_get_data']);
        
        // Register AJAX handler for non-logged-in users
        add_action('wp_ajax_nopriv_' . self::ACTION, [$this, 'handle_get_data']);
        
        // Register AJAX handler for refresh (logged-in users only)
        add_action('wp_ajax_' . self::REFRESH_ACTION, [$this, 'handle_refresh_data']);
    }
