...
(function ($) {
  ...
  function refreshData($btn) {
    ...
    $btn.html('<span class="dashicons dashicons-update spin"></span> ' + escapeHtml(wilsonApiAdmin.i18n.refreshing));
    ...
    $.ajax({
      ...
      success: function (response) {
        if (response.success) {
          ...
          const errorMessage = response.data && response.data.message ? response.data.message : wilsonApiAdmin.i18n.error;
